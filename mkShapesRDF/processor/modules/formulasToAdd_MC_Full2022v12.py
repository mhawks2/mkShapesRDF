...
class formulasToAdd_MC_Full2022v12(Module):
    def __init__(self):
        super().__init__("formulasToAdd_MC_Full2022v12")
    ...
    def runModule(self, df, values):
        ...
        muWPlist = [wp for wp in MuonWP["Full2022v12"]["TightObjWP"]]
        eleWPlist = [wp for wp in ElectronWP["Full2022v12"]["TightObjWP"]]
