...
class formulasToAdd_MCnoSF_Full2023v12(Module):
    def __init__(self):
        super().__init__("formulasToAdd_MCnoSF_Full2023v12")
    ...
    def runModule(self, df, values):
        ...
        muWPlist = [wp for wp in MuonWP["Full2023v12"]["TightObjWP"]]
        eleWPlist = [wp for wp in ElectronWP["Full2023v12"]["TightObjWP"]]
